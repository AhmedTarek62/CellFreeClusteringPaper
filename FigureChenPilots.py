...
while layout < num_layouts:
    ...
    clusters = massive_access_clustering(network_km.channel_model.path_loss_shadowing, num_pilots)
    _, pilots_emil = emil_heuristic_dcc_pilot_assignment(network_km.channel_model.path_loss_shadowing, num_pilots)
    pilots_ug = user_group(network_km.channel_model.path_loss_shadowing, num_pilots, clusters)
    ...
    for i, (processing, alg) in enumerate(cases):
        ...
        combiners_km = network_km.simulate_uplink_centralized(alg, channels_km, channel_estimates_km)
        precoders_km = network_km.simulate_downlink_centralized(alg, channels_km, channel_estimates_km)
