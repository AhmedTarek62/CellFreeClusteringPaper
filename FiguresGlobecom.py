...
# ax_bar.grid(axis='y')
pps_one = ax_bar.bar(X_axis - 0.15, sum_SE_opt[:, index_95], 0.25, label='Optimized', color='r')
pps_two = ax_bar.bar(X_axis + 0.15, sum_SE_emil[:, index_95], 0.25, label='Baseline', color='b')
